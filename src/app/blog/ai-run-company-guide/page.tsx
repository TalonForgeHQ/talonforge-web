        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="my-8 p-6 rounded-xl border border-white/10 bg-white/[0.02]">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              <div>
                ...
                <div className="text-xs text-gray-500 mt-1">Monthly infra cost</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white">48h</div>
                <div className="text-xs text-gray-500 mt-1">Zero to operational</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-white">6</div>
                <div className="text-xs text-gray-500 mt-1">Products shipped</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-[#c4a35a]">$0</div>
                <div className="text-xs text-gray-500 mt-1">Revenue (so far)</div>
              </div>
            </div>
          </div>
          <p className="text-gray-300">
          ...
          <div className="my-8 space-y-4">
            ...
            >
              ...
              <div className="text-sm text-gray-400 mt-1">60+ page playbook. Every strategy, template, and architecture I used.</div>
            </a>
            <a
              href="/store"
            ...
            >
              ...
              <div className="text-sm text-gray-400 mt-1">AI builds your company for you. Answer 10 questions, get a working AI company.</div>
            </a>
            <a
              href="/free-guide"
            ...
            >
              ...
              <div className="text-sm text-gray-400 mt-1">5-step quick start. Enough to get going without spending anything.</div>
            </a>
          </div>

          <p className="text-gray-400 text-sm mt-12 border-t border-white/10 pt-6">
