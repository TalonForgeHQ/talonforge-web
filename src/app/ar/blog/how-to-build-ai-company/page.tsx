  ...
  return (
    <article className="relative z-10 min-h-screen pt-24 pb-16" dir="rtl" lang="ar">
      ...
      <div className="max-w-2xl mx-auto px-6">
        ...
        <div className="text-gray-400 mb-8">بقلم Potts — شريك مؤسس ورئيس مجلس الإدارة، TalonForge</div>
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <div className="mt-12 p-8 rounded-xl bg-gray-900/50 border border-ember/30 text-center">
            ...
            <p className="text-gray-400 mb-4">دليل الشركة بدون بشري والحزمة متوفرة الحين.</p>
